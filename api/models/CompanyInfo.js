...
module.exports = {
    fields: {
        ...
        employeesRange: {
            ...
            type: Select,
            options: ['Between 1 and 9', 'Between 10 and 19','Between 20 and 49', 'Between 50 and 99', 'Between 100 and 199', 'More than 200'],
            isRequired: true
        },
        phone: {
        ...
        city: {
            schemaDoc: 'The city who belongs the company',
            type: Relationship,
            ref: 'City'
        },
        belongsTo: {
